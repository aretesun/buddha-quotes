...
- Unsplash의 아름다운 배경 이미지와 함께 명언이 생성됩니다
...
명언을 Unsplash의 아름다운 배경 이미지와 함께 멋진 이미지로 저장할 수 있습니다!

### 작동 방식
1. 원하는 명언 옆의 📤 버튼을 클릭합니다
2. 시스템이 자동으로 Unsplash에서 평화로운 배경 이미지를 가져옵니다
...
- **배경 소스**: Unsplash Source API
- **렌더링**: HTML5 Canvas API
- **폰트**: Noto Sans KR (한글 최적화)
- **오버레이**: 가독성을 위한 다크 오버레이
